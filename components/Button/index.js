  ...
  return (
    <div className="col-span-2 md:col-span-1 text-center bg-[#222] pt-4">
      <div className="flex justify-center items-center py-6 w-full p-5">
        ...
        <Link href="/contact">
          <a className="bg-gannet-400 px-6 p-2 border-2 border-gannet-800 hover:border-gannet-400 rounded-md hover:bg-gannet-600 hover:text-gannet-200 transition duration-300 ease-in-out text-lg">
            Contact us
          </a>
        </Link>
      </div>
