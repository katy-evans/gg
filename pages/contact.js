...
const contact = () => {
  return (
    <>
      <section className="max-w-7xl mx-auto font-display">
                ...
                <div className="col-span-2 md:col-span-1 text-center">
                  <div className="flex justify-center items-center p-2">
                    <div className="py-4 mt-4 w-full">
                      ...
                      <div className="pt-9 col-span-2">
                        <button
                          type="submit"
                          className="rounded-none p-2 w-full focus:outline-none focus:ring-2 focus:ring-offset-2 shadow-md rounded-md bg-gannet-400 text-[#222] hover:bg-gannet-600 hover:text-white transition duration-300"
                        >
